...
udemy_ros2_pkg__srv__ImageFromAngle_Request__create()
{
  ...
  udemy_ros2_pkg__srv__ImageFromAngle_Request * msg = (udemy_ros2_pkg__srv__ImageFromAngle_Request *)allocator.allocate(sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Request));
  bool success = udemy_ros2_pkg__srv__ImageFromAngle_Request__init(msg);
  if (!success) {
...
udemy_ros2_pkg__srv__ImageFromAngle_Request__destroy(udemy_ros2_pkg__srv__ImageFromAngle_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    udemy_ros2_pkg__srv__ImageFromAngle_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__init(udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  udemy_ros2_pkg__srv__ImageFromAngle_Request * data = NULL;

  if (size) {
    data = (udemy_ros2_pkg__srv__ImageFromAngle_Request *)allocator.zero_allocate(size, sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = udemy_ros2_pkg__srv__ImageFromAngle_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        udemy_ros2_pkg__srv__ImageFromAngle_Request__fini(&data[i - 1]);
      }
...
udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__fini(udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      udemy_ros2_pkg__srv__ImageFromAngle_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * array = (udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence *)allocator.allocate(sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__init(array, size);
  if (!success) {
...
udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__destroy(udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence__are_equal(const udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * lhs, const udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!udemy_ros2_pkg__srv__ImageFromAngle_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  udemy_ros2_pkg__srv__ImageFromAngle_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    udemy_ros2_pkg__srv__ImageFromAngle_Request * data =
      (udemy_ros2_pkg__srv__ImageFromAngle_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!udemy_ros2_pkg__srv__ImageFromAngle_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          udemy_ros2_pkg__srv__ImageFromAngle_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!udemy_ros2_pkg__srv__ImageFromAngle_Request__copy(
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__init(udemy_ros2_pkg__srv__ImageFromAngle_Response * msg)
{
  ...
  // image_from_angle
  if (!sensor_msgs__msg__Image__init(&msg->image_from_angle)) {
    udemy_ros2_pkg__srv__ImageFromAngle_Response__fini(msg);
    return false;
  }
  return true;
}
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__fini(udemy_ros2_pkg__srv__ImageFromAngle_Response * msg)
{
  ...
  // image_from_angle
  sensor_msgs__msg__Image__fini(&msg->image_from_angle);
}
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__are_equal(const udemy_ros2_pkg__srv__ImageFromAngle_Response * lhs, const udemy_ros2_pkg__srv__ImageFromAngle_Response * rhs)
{
  ...
  if (!sensor_msgs__msg__Image__are_equal(
      &(lhs->image_from_angle), &(rhs->image_from_angle)))
  {
    return false;
  }
  return true;
  ...
  udemy_ros2_pkg__srv__ImageFromAngle_Response * output)
{
  ...
  if (!sensor_msgs__msg__Image__copy(
      &(input->image_from_angle), &(output->image_from_angle)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  udemy_ros2_pkg__srv__ImageFromAngle_Response * msg = (udemy_ros2_pkg__srv__ImageFromAngle_Response *)allocator.allocate(sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Response));
  bool success = udemy_ros2_pkg__srv__ImageFromAngle_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__init(udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  udemy_ros2_pkg__srv__ImageFromAngle_Response * data = NULL;

  if (size) {
    data = (udemy_ros2_pkg__srv__ImageFromAngle_Response *)allocator.zero_allocate(size, sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = udemy_ros2_pkg__srv__ImageFromAngle_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        udemy_ros2_pkg__srv__ImageFromAngle_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__fini(udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      udemy_ros2_pkg__srv__ImageFromAngle_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * array = (udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence *)allocator.allocate(sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__destroy(udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence__are_equal(const udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * lhs, const udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!udemy_ros2_pkg__srv__ImageFromAngle_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  udemy_ros2_pkg__srv__ImageFromAngle_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(udemy_ros2_pkg__srv__ImageFromAngle_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    udemy_ros2_pkg__srv__ImageFromAngle_Response * data =
      (udemy_ros2_pkg__srv__ImageFromAngle_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!udemy_ros2_pkg__srv__ImageFromAngle_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          udemy_ros2_pkg__srv__ImageFromAngle_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!udemy_ros2_pkg__srv__ImageFromAngle_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
