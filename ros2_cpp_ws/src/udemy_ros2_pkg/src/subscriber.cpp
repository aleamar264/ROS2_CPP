...
public:
  HelloWorldSubNode() : Node("hello_world_sub_node") {
    subscrtiption_ = this->create_subscription<std_msgs::msg::String>(
        "hello_world", 10,
        std::bind(&HelloWorldSubNode::sub_callback, this,
                  std::placeholders::_1));
  };
...
private:
  ...
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr subscrtiption_;
};
